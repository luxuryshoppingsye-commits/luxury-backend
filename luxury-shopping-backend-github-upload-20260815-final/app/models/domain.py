...
COMMON_FIELD_SPECS: dict[str, Any] = {
    ...
    "return_id": lambda: _col(UUID(as_uuid=True), index=True),
    "order_item_id": lambda: _col(UUID(as_uuid=True), index=True),
    ...
    "is_verified_purchase": lambda: _col(Boolean, server_default="false"),
    "is_approved": lambda: _col(Boolean, server_default="false", index=True),
...
RESOURCE_SPECS: dict[str, tuple[str, ...]] = {
    ...
    "product_reviews": ("user_id", "product_id", "order_id", "status", "title", "body", "rating", "comment", "review_images", "is_verified_purchase", "is_approved"),
    ...
    "returns": ("order_id", "user_id", "status", "amount", "fee", "refund_amount", "reason", "refund_method", "requested_by", "reviewed_by", "reviewed_at"),
    "return_items": ("return_id", "order_id", "user_id", "order_item_id", "product_id", "product_name", "quantity", "unit_price", "amount", "status", "reason"),
