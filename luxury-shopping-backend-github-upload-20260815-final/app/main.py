...
CRITICAL_SECURITY_TABLES = (
    ...
    # production databases that have not yet run the migration.
    "refresh_tokens",
...
PRIVATE_NO_STORE_PREFIXES = (
    ...
    "/api/storage/migrate-render-to-r2",
    "/storage/remove",
    "/api/storage/remove",
)
...
ERROR_MESSAGES: dict[str, str] = {
    ...
    "admin_disabled": "This account was disabled by an administrator.",
    "account_not_active": "This account is not active.",
    "inactive_user": "This account is disabled or unavailable.",
